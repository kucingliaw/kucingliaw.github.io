...
const WorkExperienceData: WorkExperienceItem[] = [
  ...
  },
  {
    ...
    position: "Computer Staff",
    description:
      "Successfully revitalized and optimized the 194 Junior High School computer lab, bringing 47 previously non-functional computers back to full operational status and installing a new wired LAN network to support school examinations.",
  },
  {
